...
var style_adm_prov__1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("IR DBD");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 52.120000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 52.120000 && value <= 181.310000) {
            style = [ new ol.style.Style({
